...
from gui.elements import RefineBox, SamplerBox, SeedBox

class TxtBaseInterface(VerticalScrollWidget):
    ...
    def get_payload(self):
        payload = {}
        payload.update(self.sampler_box.get_payload())
